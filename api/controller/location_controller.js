...
exports.deleteLocation = async (req, res, next) => {
  try {
    await Location.sequelize.query(`DELETE FROM myan_market.location WHERE id = :id`, {
      replacements: { id: req.params.marketId }, // Corrected to use :id and matched param name
